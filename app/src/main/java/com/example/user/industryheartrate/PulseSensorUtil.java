           ...
           Log.i("HRSFagment signal ", String.valueOf(signal));
            ...
            if (timeInterval > 250) {                               // avoid high frequency noise
                if ((signal > threshold) && (!pulse) && (timeInterval > (ibi / 5) * 3)) {
                    ...
                    Log.i("HRSFragment The IBI is ", String.valueOf(sampleCounter));
                    ...
                    //return new String[]{String.valueOf(timeInterval),String.valueOf(bpm),String.valueOf(trough),String.valueOf(peak)
                            //String.valueOf(ibi)};
